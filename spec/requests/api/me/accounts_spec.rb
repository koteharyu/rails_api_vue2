...
RSpec.describe "Api::Me::Accounts", type: :request do
  describe "PATCH /api/me/account" do
    ...
    let(:user_params) { { user: { name: "update_name", introduction: "update_introduction", avatar: fixture_file_upload(Rails.root.join('spec', 'fixtures', 'test.png')), tag_names: ['Ruby', 'Rails']} } }
